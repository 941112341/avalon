...
type MessageRequest struct {
	...
	Base *Base `thrift:"base,255" db:"base" json:"base"`
}
...
var MessageRequest_Base_DEFAULT *Base

func (p *MessageRequest) GetBase() *Base {
	if !p.IsSetBase() {
		return MessageRequest_Base_DEFAULT
	}
	return p.Base
}
func (p *MessageRequest) IsSetBase() bool {
	return p.Base != nil
}
...
func (p *MessageRequest) ReadField255(iprot thrift.TProtocol) error {
	p.Base = &Base{}
...
func (p *MessageRequest) writeField255(oprot thrift.TProtocol) (err error) {
...
type MessageResponse struct {
	...
	BaseResp *BaseResp `thrift:"baseResp,255" db:"baseResp" json:"baseResp"`
}
...
var MessageResponse_BaseResp_DEFAULT *BaseResp

func (p *MessageResponse) GetBaseResp() *BaseResp {
	if !p.IsSetBaseResp() {
		return MessageResponse_BaseResp_DEFAULT
	}
	return p.BaseResp
}
func (p *MessageResponse) IsSetBaseResp() bool {
...
func (p *MessageResponse) ReadField255(iprot thrift.TProtocol) error {
	p.BaseResp = &BaseResp{}
...
func (p *MessageResponse) writeField255(oprot thrift.TProtocol) (err error) {
