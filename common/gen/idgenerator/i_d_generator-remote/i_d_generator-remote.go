...
var _ = idgenerator.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  IDResponse GenIDs(IDRequest request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  case "GenIDs":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GenIDs requires 1 args")
      flag.Usage()
    }
    arg5 := flag.Arg(1)
    ...
    argvalue0 := idgenerator.NewIDRequest()
    ...
    value0 := argvalue0
    fmt.Print(client.GenIDs(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
