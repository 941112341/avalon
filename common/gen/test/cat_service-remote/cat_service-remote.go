...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  CatResponse GetCat(CatRequest request)")
  fmt.Fprintln(os.Stderr, "  LittleCatResponse GetLittleCat(LittleCatRequest request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := test.NewCatServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "GetCat":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetCat requires 1 args")
      flag.Usage()
    }
    arg14 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.GetCat(context.Background(), value0))
    fmt.Print("\n")
    break
  case "GetLittleCat":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetLittleCat requires 1 args")
      flag.Usage()
    }
    arg20 := flag.Arg(1)
    ...
    argvalue0 := test.NewLittleCatRequest()
    ...
    value0 := argvalue0
    fmt.Print(client.GetLittleCat(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
